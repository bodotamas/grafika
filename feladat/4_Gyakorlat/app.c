...
void handle_app_events(App* app)
{
    if (app->event.type == SDL_KEYDOWN) 
    {
        ...
        {
            set_camera_vertical_speed(&app->camera, -1.0);  
        } else if (app->event.key.keysym.sym == SDLK_j) 
        {
            rotate_camera(&app->camera, -1.0, 0.0);  
        } else if (app->event.key.keysym.sym == SDLK_l) 
        {
            rotate_camera(&app->camera, 1.0, 0.0);  
        }
    } 
    ...
    {
        if (app->event.key.keysym.sym == SDLK_q || app->event.key.keysym.sym == SDLK_e) 
        {
